"""
Evaluate TaDiff FLAIR generation PSNR on MU-Glioma-Post test patients.
...
- Stack 3 FLAIR slices and compute PSNR
"""
...
def _psnr_from_numpy_chw(pred_01: np.ndarray, gt_01: np.ndarray) -> float:
    """
    Compute PSNR on stacked 3-slice FLAIR inputs [3,H,W] in [0,1].
    """
...
def run_eval(
    ...
    for patient_id in patient_ids:
        ...
        # Compute one PSNR on the stacked 3-channel input.
        psnr_val = _psnr_from_numpy_chw(pred_chw_01, gt_chw_01)
        ...
        rows.append(
            {
                ...
                "psnr_flair_3slice": float(psnr_val),
            }
        )
        print(
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate TaDiff 3-slice FLAIR PSNR on MU-Glioma-Post.")
    ...
    parser.add_argument("--output_json", type=str, default="./eval_t2f_generation/psnr_results.json")
